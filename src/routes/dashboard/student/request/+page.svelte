...
async function submitRequest() {
    ...
    try {
        ...
        if (res.ok) {
            alert("Request sent directly to professor!");
...
"></div>
    ...
    px-6 gap-12">
        ...
        <section class="max-w-lg">
            <h1 class="text-4xl font-extrabold leading-tight mt-12 md:mt-0 mb-4
    text-center lg:text-left">
        ...
        <section class="w-full max-w-xl
            ...
            <!-- Category -->
            <div class="mb-4">
                <label for="category" class="block mb-1 font-semibold">
                    Category
                </label>
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    <div class="block mb-1 font-semibold pt-3">
...
<!-- FOOTER -->
    <footer class="border-t border-gray-400 dark:border-gray-700 py-8 mt-10
